  ...
  const getFooter = () => {
    ...
    return (
      <>
        ...
        <button class="btn btn-outline-danger" type="reset">Отменить</button>
      </>
    );
  };
...
<div className="input-group-prepend">
    <span className="input-group-text" id="inputGroup-sizing-default">Категория</span>
  </div>
  <select name="category" onChange={handleChange} className="custom-select col-3" id="inputGroupSelect04" aria-label="Example select with button addon"  value={editedPurchase.item.category}>
  ...
  <div className="input-group-prepend">
    <span className="input-group-text" id="inputGroup-sizing-default">Цена</span>
  </div>
  <input name="price"
